...
const colors = {
  gradients: {
    ...
    gradient:
      "linear-gradient(71deg, #08DB81 -14.89%, #5EABE3 48.78%, #E16376 113.49%)",
  },
  shadows: {
    success:
    ...
    card: "0px 0px 1px #6A7199",
    cardSm: "0px 0px 1px #6A7199",
    cardLg: "0px 0px 1px #6A7199",
  },
  layout: {
    general: {
  ...
  error: {
    ...
    dark: darken(themeColors.error, 0.6),
  },
  info: {
...
export const ThemeOne = createTheme({
  colors: {
    gradients: {
      ...
      gradient1: colors.gradients.gradient,
    },
    shadows: {
  ...
  palette: {
    ...
    background: {
      paper: colors.layout.general.bodyBg,
